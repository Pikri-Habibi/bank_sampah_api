    ...
    public function store(Request $request)
{
    ...
    DB::transaction(function () use ($request, $petugas) {
        ...
        /*
        |--------------------------------------------------------------------------
        | 1. Buat transaksi setoran utama
        |--------------------------------------------------------------------------
        */
        ...
        $setoran = Setoran::create([
            ...
            // Untuk sementara diisi null.
            // Harga sebenarnya disimpan di detail_setoran.
        ...
        */
        ...
        foreach ($request->items as $detail) {
            ...
            if (!$harga) {
                throw new \Exception(
                    'Harga sampah belum tersedia untuk salah satu jenis sampah.'
                );
            }
            ...
            */
            ...
            /*
            |--------------------------------------------------------------------------
            | 4. Tambahkan subtotal ke total saldo
            |--------------------------------------------------------------------------
            */
        ...
        /*
        |--------------------------------------------------------------------------
        | 5. Tambahkan total transaksi ke saldo nasabah
        |--------------------------------------------------------------------------
        */

        $nasabah = Nasabah::findOrFail(
            $request->id_pengguna_nasabah
        );
    ...
    return redirect()
        ...
        ->with(
            'success',
            'Setoran berhasil diproses dan saldo nasabah bertambah.'
        );
    }
}
